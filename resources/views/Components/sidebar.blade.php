    ...
    <nav class="flex-1 p-4 space-y-1 text-sm">
        ...
        <div x-data="{ open_akademik: false }" class="space-y-1">
            ...
            <div x-show="open_akademik" 
                 ...
                 class="pl-4 space-y-1"
                 x-cloak>
        <a href="/penilaian" class="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
        ...
        <a href="/absensi" class="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
